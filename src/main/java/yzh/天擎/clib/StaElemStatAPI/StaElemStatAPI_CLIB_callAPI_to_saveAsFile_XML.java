 ...
 */
public class StaElemStatAPI_CLIB_callAPI_to_saveAsFile_XML {
	/*
	 * main方法 
	...
	public static void main(String[] args) {
	    ...
	    /* 2.5 文件的本地全路径 */
	    String savePath = "F:/temp/StaElemStatAPI_CLIB_callAPI_to_saveAsFile_XML.xml" ;
	    /* 2.6 返回文件的描述对象 */
	    ...
	    try {
	    	...
	    	if(rst == 0) { //正常返回
	    		...
	    		System.out.println( "[error] StaElemStatAPI_CLIB_callAPI_to_saveAsFile_XML." ) ;       
