 ...
 * 格点场要素获取（切块），写JSON文件
 */
public class GridElemRectSearchAPI_CLIB_callAPI_to_saveAsFile_JSON {
	/*
    * main方法
    ...
    */
	public static void main(String[] args) {
		...
		/* 2.5 文件的本地全路径 */
		String savePath = "F:/temp/GridElemRectSearchAPI_CLIB_callAPI_to_saveAsFile_JSON.json";
		/* 2.6 返回文件的描述对象 */
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				System.out
						.println("[error] GridElemRectSearchAPI_CLIB_callAPI_to_saveAsFile_JSON.");
