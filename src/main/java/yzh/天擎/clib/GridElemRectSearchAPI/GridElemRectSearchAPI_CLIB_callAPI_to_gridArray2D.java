...
/*
 * 客户端调取，格点场要素获取（切块），返回RetGridArray2D对象
 */
public class GridElemRectSearchAPI_CLIB_callAPI_to_gridArray2D {
    ...
    public static void main(String[] args) {
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				System.out
						.println("[error] GridElemRectSearchAPI_CLIB_callAPI_to_gridArray2D.");
