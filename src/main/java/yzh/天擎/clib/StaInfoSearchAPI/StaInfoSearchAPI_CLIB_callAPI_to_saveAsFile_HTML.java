 ...
 */
public class StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_HTML {
	/*
	 * main方法，程序入口
	...
	public static void main(String[] args) {
	    ...
	    /* 2.5 文件的本地全路径 */
	    String savePath = "F:/temp/StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_HTML.html" ;
	    /* 2.6 返回文件的描述对象 */
	    ...
	    try {
	    	...
	    	if(rst == 0) { //正常返回
	    		...
	    		System.out.println( "[error] StaInfoSearchAPI_CLIB_callAPI_to_saveAsFile_HTML." ) ;       
