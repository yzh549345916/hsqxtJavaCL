 ...
 */
public class StaInfoSearchAPI_CLIB_callAPI_to_array2D {
	...
	public static void main(String[] args) {
		...
		params.put("elements", "Station_ID_C,Station_Name,Lat,Lon,Alti") ; //检索要素：站号、站名、小时降水、气压、相对湿度、能见度、2分钟平均风速、2分钟风向		
		...
		try {
			...
			if(rst == 0) { //正常返回
				...
				System.out.println( "[error] StaInfoSearchAPI_CLIB_callAPI_to_array2D." ) ;				
