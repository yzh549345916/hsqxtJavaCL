 ...
 */
public class GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_TEXT {
	/*
	 * main方法 
	...
	public static void main(String[] args) {
		...
		/* 2.5 文件的本地全路径 */
		String savePath = "GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_TEXT.txt";
		/* 2.6 返回文件的描述对象 */
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				System.out
						.println("[error] GridElemPointSearchAPI_CLIB_callAPI_to_saveAsFile_TEXT.");
