...
/*
 * 客户端调取，文件信息列表检索，返回text格式的文件列表信息
 */
public class FileInfoSearchAPI_CLIB_callAPI_to_serializedStr_TEXT {
	/**
	 * main方法 
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (rst == 0) { // 正常返回
				...
				System.out
						.println("[error] FileInfoSearchAPI_CLIB_callAPI_to_serializedStr_TEXT.");
