 ...
 */
public class StaElemSearchAPI_CLIB_callAPI_to_serializedStr_XML {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if(rst == 0) { //正常返回
        ...
        formatUtil.outputRstXml( retStr.toString() ) ;
      } else { //异常返回
        System.out.println( "[error] StaElemSearchAPI_CLIB_callAPI_to_serializedStr_XML." ) ;       
